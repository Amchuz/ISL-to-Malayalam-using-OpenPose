...
SRC_MODEL_PATH = "//home/amchuz/Desktop/Realtime-Action-Recognition-master/src/model/trained_classifier.pickle"

DST_FOLDER_NAME = get_dst_folder_name(SRC_DATA_TYPE, SRC_DATA_PATH)

# -- Settings

cfg_all = lib_commons.read_yaml("/home/amchuz/Desktop/Realtime-Action-Recognition-master/src/utils/config/config.yaml")
...
if __name__ == "__main__":
    ...
    displayer=lib_images_io.Displayer()
    ...
    try:
        ...
        while images_loader.has_image():
            ...
            if(count==5):
                ...
                pass
            displayer.display(img_disp,word, wait_key_ms=1)
